...
jQuery('body').append('' + 
	'<div id="color-style-switcher">' +
		'<div>' + 
			...
			'</ul>' +
		'</div>' +
		'<div class="bottom"> <a href="https://donorbox.org/ecumenic" class="custom-dbox-popup settings" target="_blank"><img src="./img/donate-tab.png" alt="Sponsor Our Project: Donate"></a></div>' +
	'</div>' +
'');
